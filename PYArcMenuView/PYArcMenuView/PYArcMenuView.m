...
// 默认开关按钮图标
#define DEFAULT_BUTTON_IMAGE [UIImage imageNamed:@"PYArcMenu_button_image"]
// 默认菜单项按钮的宽和高
#define DEFAULT_BUTTON_ITEM_WIDTH 30
#define DEFAULT_BUTTON_ITEM_HEIGHT 30
// 默认菜单项容量
#define DEFAULT_CAPACITY 6
// 默认菜单半径
#define DEFAULT_MENU_RADIUS 100
// 默认菜单展开动画时长
#define DEFAULT_MENU_EXPAND_INTERVAL 0.5f
// 默认菜单展开动画延迟
#define DEFAULT_MENU_EXPAND_DELAY 0.2f
// 默认按钮点击动画时长
